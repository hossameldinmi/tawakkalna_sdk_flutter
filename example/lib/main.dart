...
class _TawakkalnaDemoState extends State<TawakkalnaDemo> {
  final _twk = Twk(
    v1Api: TwkApiV1DemoJsonImpl(jsonPath: 'packages/tawakkalna_sdk_flutter/assets/mock_profile1.0.2.json'),
    v2Api: TwkApiV2DemoJsonImpl(jsonPath: 'packages/tawakkalna_sdk_flutter/assets/mock_profile1.0.2.json'),
  );
                ...
                children: [
                  ...
                  _buildSection(
                    ...
                    [
                      _buildMethodButton(
                        ...
                        'V2: Token',
                        Icons.vpn_key,
                        () => _twk.v2.generateToken(),
                      ),
                      _buildMethodButton(
                        'Get Full Name',
                        'V2: Full Name',
                        Icons.person,
                        () => _twk.v2.getUserFullName(),
                      ),
                      _buildMethodButton(
                        'Get Nationality',
                        'V2: Nationality',
                  ...
                  _buildSection(
                    ...
                    [
                      ...
                      _buildMethodButton(
                          'Birth City', 'V1: Birth City', Icons.location_city, () => _twk.v1.getUserBirthCity()),
                      _buildMethodButton(
                          'Nationality', 'V1: Nationality', Icons.flag, () => _twk.v1.getUserNationality()),
                      _buildMethodButton('Nationality ISO', 'V1: Nationality ISO', Icons.outlined_flag,
                  ...
                  _buildSection(
                    ...
                    [
                      _buildMethodButton(
                          'Mobile Number', 'V1: Mobile Number', Icons.phone, () => _twk.v1.getUserMobileNumber()),
                      _buildMethodButton('Email', 'V1: Email', Icons.email, () => _twk.v1.getUserEmail()),
                      _buildMethodButton(
                          'Location', 'V1: Location', Icons.location_on, () => _twk.v1.getUserLocation()),
                      _buildMethodButton('National Address', 'V1: National Address', Icons.home,
                  ...
                  _buildSection(
                    ...
                    [
                      _buildMethodButton(
                          'Passports', 'V1: Passports', Icons.airplane_ticket, () => _twk.v1.getUserPassports()),
                      _buildMethodButton(
                          'ID Expiry Date', 'V1: ID Expiry Date', Icons.event, () => _twk.v1.getUserIdExpiryDate()),
                      _buildMethodButton('Document Number', 'V1: Document Number', Icons.numbers,
                          () => _twk.v1.getUserDocumentNumber()),
                      _buildMethodButton(
                          'Iqama Type', 'V1: Iqama Type', Icons.card_membership, () => _twk.v1.getUserIqamaType()),
                      _buildMethodButton(
                          'Profile Photo', 'V1: Profile Photo', Icons.photo, () => _twk.v1.getUserProfilePhoto()),
                    ],
                  ),
                  const SizedBox(height: 16),
                  _buildSection(
                    ...
                    [
                      _buildMethodButton(
                          'Blood Type', 'V1: Blood Type', Icons.bloodtype, () => _twk.v1.getUserBloodType()),
                      _buildMethodButton('Health Status', 'V1: Health Status', Icons.medical_services,
                          () => _twk.v1.getUserHealthStatus()),
                      _buildMethodButton('Disability Type', 'V1: Disability Type', Icons.accessible,
                          () => _twk.v1.getUserDisabilityType()),
                      _buildMethodButton(
                          'Marital Status', 'V1: Marital Status', Icons.favorite, () => _twk.v1.getUserMaritalStatus()),
                    ],
                  ),
                  const SizedBox(height: 16),
                  _buildSection(
                    ...
                    [
                      _buildMethodButton(
                          'Degree Type', 'V1: Degree Type', Icons.school, () => _twk.v1.getUserDegreeType()),
                      _buildMethodButton('Occupation', 'V1: Occupation', Icons.work, () => _twk.v1.getUserOccupation()),
                    ],
                  ),
                  const SizedBox(height: 16),
                  _buildSection(
                    'V1 Vehicles & Violations',
                    Icons.directions_car,
                    Colors.brown,
                    [
                      _buildMethodButton('Vehicles', 'V1: Vehicles', Icons.car_rental, () => _twk.v1.getUserVehicles()),
                      _buildMethodButton('Unpaid Violations', 'V1: Unpaid Violations', Icons.warning,
                          () => _twk.v1.getUserUnPaidViolations()),
                      _buildMethodButton('Paid Violations', 'V1: Paid Violations', Icons.check_circle_outline,
                  ...
                  _buildSection(
                    ...
                    [
                      _buildMethodButton(
                          'Device Info', 'V1: Device Info', Icons.phone_android, () => _twk.v1.getDeviceInfo()),
                    ],
                  ),
                ],
              ),
    ...
    return Padding(
      ...
      child: ElevatedButton.icon(
        ...
        icon: isLoading
            ...
            : Icon(
                hasResult ? (isError ? Icons.error : Icons.check_circle) : icon,
                size: 18,
              ),
        label: Text(
          label,
    ...
    return Card(
      ...
      child: ExpansionTile(
        ...
        subtitle: Text(
          ...
          style: TextStyle(
            fontSize: 12,
            color: isError ? Colors.red[700] : Colors.grey,
          ),
        ),
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border(
                top: BorderSide(color: isError ? Colors.red[200]! : Colors.grey[300]!),
              ),
            ),
