...
window.TWK = {
  ...
  getRawData: function (file) {
    return Promise.resolve(getMockData('/raw_data'));
  },
  getUserId: function () {
    return Promise.resolve(getMockData('/user_data/user_id'));
  },
  getUserType: function () {
    return Promise.resolve(getMockData('/user_data/user_type'));
  },
  getUserBirthDate: function () {
    return Promise.resolve(getMockData('/user_data/birth_date'));
  },
  getUserMobileNumber: function () {
    return Promise.resolve(getMockData('/user_data/mobile_number'));
  },
  getUserGender: function () {
    return Promise.resolve(getMockData('/user_data/gender'));
  },
  getUserLocation: function () {
    return Promise.resolve(getMockData('/user_data/user_location'));
  },
  getUserNationality: function () {
    return Promise.resolve(getMockData('/user_data/nationality_name'));
  },
  getUserNationalityISO: function () {
    return Promise.resolve(getMockData('/user_data/nationality_iso'));
  },
  getUserFullName: function () {
    return Promise.resolve(getMockData('/user_data/full_name'));
  },
  getUserMaritalStatus: function () {
    return Promise.resolve(getMockData('/user_data/marital_status'));
  },
  getUserHealthStatus: function () {
    return Promise.resolve(getMockData('/user_data/health_status'));
  },
  getUserDisabilityType: function () {
    return Promise.resolve(getMockData('/user_data/disability_type'));
  },
  getUserBloodType: function () {
    return Promise.resolve(getMockData('/user_data/blood_type'));
  },
  getUserNationalAddress: function () {
    return Promise.resolve(getMockData('/user_data/national_address'));
  },
  getUserDegreeType: function () {
    return Promise.resolve(getMockData('/user_data/degree_type'));
  },
  getUserOccupation: function () {
    return Promise.resolve(getMockData('/user_data/occupation'));
  },
  getUserFamilyMembers: function (minage, maxage, gender) {
    return Promise.resolve(getMockData('/user_data/family_members'));
  },
  getUserSponsors: function (minage, maxage, gender) {
    return Promise.resolve(getMockData('/user_data/sponsors'));
  },
  getUserUnPaidViolations: function () {
    return Promise.resolve(getMockData('/user_data/violations/unpaid'));
  },
  getUserPaidViolations: function () {
    return Promise.resolve(getMockData('/user_data/violations/paid'));
  },
  getUserVehicles: function () {
    return Promise.resolve(getMockData('/user_data/vehicles'));
  },
  getUserProfilePhoto: function () {
    return Promise.resolve(getMockData('/user_data/user_photo'));
  },
  getUserPassports: function () {
    return Promise.resolve(getMockData('/user_data/passports'));
  },
  getDeviceInfo: function () {
    return Promise.resolve(getMockData('/capabilities'));
  },
  getGallerySingle: function () {
    return Promise.resolve(getMockData('/gallery/image/single'));
  },
  getGalleryMulti: function () {
    return Promise.resolve(getMockData('/gallery/image/multi'));
  },
  getGallerySingleVideo: function () {
    return Promise.resolve(getMockData('/gallery/video/single'));
  },
  getGalleryMultiVideo: function () {
    return Promise.resolve(getMockData('/gallery/video/multi'));
  },
  getCameraPhoto: function () {
    return Promise.resolve(getMockData('/camera/image'));
  },
  getCameraVideo: function () {
    return Promise.resolve(getMockData('/camera/video'));
  },
  getFileBase64: function () {
    return Promise.resolve(getMockData('/files/base64'));
  },
  getFileId: function () {
    return Promise.resolve(getMockData('/files'));
  },
  askUserLocationPermission: function () {
    return Promise.resolve(getMockData('/ask_permissions/location'));
  },
  askUserPreciseLocationPermission: function () {
    return Promise.resolve(getMockData('/ask_permissions/precise_location'));
  },
  askCameraPermission: function () {
    return Promise.resolve(getMockData('/ask_permissions/camera'));
  },
  askGalleryPermission: function () {
    return Promise.resolve(getMockData('/ask_permissions/gallery'));
  },
  askPushNotificationPermission: function () {
    return Promise.resolve(getMockData('/ask_permissions/push_notification'));
  },
  authenticateBiometric: function () {
    return Promise.resolve(getMockData('/authenticate/biometric'));
  },
  shareScreenShot: function () {
    return Promise.resolve(getMockData('/share/screenshot'));
  },
  openScreen: function (screenType, valuesParam) {
    return Promise.resolve(getMockData('/open_screen'));
  },
  postCard: function (actionType, payload) {
    return Promise.resolve(getMockData('/cards'));
  },
  generateToken: function () {
    return Promise.resolve(getMockData('/authenticate/generatetoken'));
  },
  share: function (fileName, content, mimetype) {
    return Promise.resolve(getMockData('/share/base64'));
  },
  scanCode: function () {
    return Promise.resolve(getMockData('/scan_code'));
  },
  openService: function (serviceId, valuesParam) {
    return Promise.resolve(getMockData('/open_service'));
  },
  getImage: function (nationalId) {
    return Promise.resolve(getMockData('/user_data/image'));
  },
  setPaymentConfiguration: function (
    ...
    return Promise.resolve(getMockData('/payment/configuration'));
  },
  generalLog: function (eventName, logType = LogType.info, logMessage) {
    return Promise.resolve(getMockData('/logger/general_log'));
  },
  apiLog: function (
    url,
    ...
    return Promise.resolve(getMockData('/logger/api_log'));
  },
  addDocument: function (
    ...
    return Promise.resolve(getMockData('/documents/add'));
  },
  updateDocument: function (
    ...
    return Promise.resolve(getMockData('/documents/update'));
  },
  deleteDocument: function (referenceNumber, categoryId) {
    return Promise.resolve(getMockData('/documents/delete'));
  },
  getUserIdExpiryDate: function () {
    return Promise.resolve(getMockData('/user_data/id_expiry_date'));
  },
  startApiIntercept: function () {
    return Promise.resolve(getMockData('/api/intercept'));
  },
  getUserDocumentNumber: function () {
    return Promise.resolve(getMockData('/user_data/user_document_number'));
  },
  getUserBirthCity: function () {
    return Promise.resolve(getMockData('/user_data/user_birth_city'));
  },
  openUrl: function (url, urlType) {
    return Promise.resolve(getMockData('/actions/open_url'));
  },
  getUserEmail: function () {
    return Promise.resolve(getMockData('/user_data/email'));
  },
  getUserIqamaType: function () {
    return Promise.resolve(getMockData('/user_data/iqama_type'));
  },
  livenessCheckCamera: function (configurations = []) {
    return Promise.resolve(getMockData('/actions/liveness_check/camera'));
  },
  livenessCheckImageFromGallery: function (configurations = []) {
    return Promise.resolve(getMockData('/actions/liveness_check/image_from_gallery'));
  },
  livenessCheckImageFromFiles: function (configurations = []) {
    return Promise.resolve(getMockData('/actions/liveness_check/image_from_files'));
  },
  getUserDocumentNumber: function () {
    return getMockData("/user_data/user_document_number");
  },
  getUserBirthCity: function () {
    return getMockData("/user_data/user_birth_city");
  },
  openUrl: function (url, urlType) {
    if (
      url === undefined ||
  ...
  getUserEmail: function () {
    return getMockData("/user_data/email");
  },
  getUserIqamaType: function () {
    return getMockData("/user_data/iqama_type");
  },
...
window.TWK.V2 = {
  generateToken: function () {
    return getMockData("/v2/authenticate/generatetoken");
  },
  getUserFullName: function () {
    return getMockData("/v2/user_data/full_name");
  },
  getUserFamilyMembers: function (minage, maxage, gender) {
   return getMockData("/v2/user_data/family_members");
  },
  getUserSponsors: function (minage, maxage, gender) {
   return getMockData("/v2/user_data/sponsors");
  },
  getUserNationality: function () {
    return getMockData("/v2/user_data/nationality_name");
  },
};
...
function fileEndpointHelper() {
  return new Promise((resolveTop) => {
    getMockData("/files").then((fileIdFetch) => {
      if (ENABLELOG == true) {
...
function getMockData(endpoint, rawForce) {
